...
export default function BirthdayMomentsPage() {
    ...
    return (
        <div className="relative min-h-screen">
            {/* Landing screen */}
            <div
                className={`transition-opacity duration-500 ease-out ${currentScreen !== 'landing' ? 'opacity-0 pointer-events-none' : 'opacity-100'
                    }`}
            >
