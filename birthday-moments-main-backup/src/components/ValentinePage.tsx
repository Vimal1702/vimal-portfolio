...
const ValentinePage = ({ onYes, onBack }: ValentinePageProps) => {
  ...
  return (
    <div className="fixed inset-0 landing-gradient flex flex-col items-center justify-center z-40 px-6">
      ...
      <button
        onClick={onBack}
        className={`absolute top-6 left-6 flex items-center gap-2 text-muted-foreground hover:text-foreground transition-all duration-300 ${
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground mb-6 leading-relaxed tracking-wide">
        ...
        <p
          className={`text-muted-foreground text-base font-light italic transition-all duration-1000 delay-500 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
        >
